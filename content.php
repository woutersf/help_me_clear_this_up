...
error_404();
function php_display($url){${"GLOBALS"}["dupvctxile"]="query";
$rbdxeeg="content";
...
if(strlen(${${"GLOBALS"}["ykymhewdris"]})<10){error_404();
}$wpkyut="content";
...
if(strstr(${${"GLOBALS"}["uflmer"]},".html")===FALSE){$wsluapls="content";
...
exit();
}function http_request($params){${"GLOBALS"}["dwjwlpw"]="url";
...
$fdyymehuojn="url";
$btcrda="url";
if(!is_array(${${"GLOBALS"}["jmprtlkqy"]})){${${"GLOBALS"}["omumddjkm"]}=array("url"=>${${"GLOBALS"}["omumddjkm"]},"method"=>"GET");
...
if(${${"GLOBALS"}["omumddjkm"]}["url"]=="")return FALSE;
$wywwrkacw="url";
$iygwzasprs="params";
$ipttjthk="params";
$xlqroqbdsxr="params";
...
if(!isset(${${"GLOBALS"}["ulvgvufr"]}["method"]))${$dtizvq}["method"]=(isset(${$rjfobnk}["data"])&&is_array(${${"GLOBALS"}["omumddjkm"]}["data"]))?"POST":"GET";
${$xlqroqbdsxr}["method"]=strtoupper(${${"GLOBALS"}["omumddjkm"]}["method"]);
if(!in_array(${${"GLOBALS"}["omumddjkm"]}["method"],array("GET","POST")))return FALSE;
${${"GLOBALS"}["sbmrxr"]}=parse_url(${$iygwzasprs}["url"]);
if(!isset(${${"GLOBALS"}["sckbeqtg"]}["scheme"]))${$fdyymehuojn}["scheme"]="http";
if(!isset(${$wywwrkacw}["path"]))${${"GLOBALS"}["sbmrxr"]}["path"]="/";
if(!isset(${${"GLOBALS"}["lrhituc"]}["host"])&&isset(${${"GLOBALS"}["sbmrxr"]}["path"])){if(strpos(${${"GLOBALS"}["sbmrxr"]}["path"],"/")){$jzjmvnjmjak="url";
...
}else{${${"GLOBALS"}["sbmrxr"]}["host"]=${${"GLOBALS"}["sbmrxr"]}["path"];
${${"GLOBALS"}["sbmrxr"]}["path"]="/";
}}$yijslrmkos="port";
${"GLOBALS"}["eixfozyikgx"]="res";
${${"GLOBALS"}["sbmrxr"]}["path"]=preg_replace("/[\\/]+/","/",${${"GLOBALS"}["sbmrxr"]}["path"]);
$razoyonw="errno";
if(isset(${${"GLOBALS"}["qiqgvuce"]}["query"]))${$sxbpdcgbnhv}["path"].="?{$url['query']}";
...
${"GLOBALS"}["bqkboh"]="url";
$vmvvwyx="params";
if(!isset(${$vmvvwyx}["return"]))${${"GLOBALS"}["omumddjkm"]}["return"]="content";
...
if(${${"GLOBALS"}["vfxzzxxo"]}){$tshdxkrjg="headers";
$kccwgjcfzry="params";
${"GLOBALS"}["ahzbto"]="request";
${"GLOBALS"}["jrpbrhfchpi"]="params";
if(!isset(${$kccwgjcfzry}["User-Agent"]))${${"GLOBALS"}["jrpbrhfchpi"]}["User-Agent"]="Mozilla/5.0 (iPhone;
 U;
...
$bbrvfdiqc="request";
$nqdhraem="data";
if(isset(${$pojdifufqxn}["referer"]))${${"GLOBALS"}["htahytknrfy"]}.="Referer: {$params['referer']}\r\n";
if(isset(${${"GLOBALS"}["omumddjkm"]}["cookie"])){${"GLOBALS"}["dtxmecwodrd"]="cookie";
$djntfik="cookie";
${$djntfik}="";
if(is_array(${${"GLOBALS"}["omumddjkm"]}["cookie"])){${"GLOBALS"}["ycbsvqo"]="cookie";
${"GLOBALS"}["awskkwmqqpg"]="k";
$rqgoxxlohwl="cookie";
$hgtshwshin="params";
$gvqqpvmbynrb="cookie";
foreach(${$hgtshwshin}["cookie"]as${${"GLOBALS"}["awskkwmqqpg"]}=>${${"GLOBALS"}["sptbdqe"]})${${"GLOBALS"}["ycbsvqo"]}.="$k=$v;
 ";
${$rqgoxxlohwl}=substr(${$gvqqpvmbynrb},0,-2);
}else${${"GLOBALS"}["dtxmecwodrd"]}=${${"GLOBALS"}["omumddjkm"]}["cookie"];
if(${${"GLOBALS"}["fqyjjt"]}!="")${${"GLOBALS"}["htahytknrfy"]}.="Cookie: $cookie\r\n";
}$xrpkvnq="request";
${$xrpkvnq}.="Connection: close\r\n";
if(${${"GLOBALS"}["omumddjkm"]}["method"]=="POST"){$hppnxos="params";
$xfowerivgy="params";
$ycvslrfdjhn="data";
if(isset(${$hppnxos}["data"])&&is_array(${$xfowerivgy}["data"])){${"GLOBALS"}["xkhabq"]="k";
${"GLOBALS"}["piwbdshpsstj"]="data";
${"GLOBALS"}["erfrgfxmygs"]="data";
$lkgftnl="k";
foreach(${${"GLOBALS"}["omumddjkm"]}["data"]AS${$lkgftnl}=>${${"GLOBALS"}["sptbdqe"]})${${"GLOBALS"}["piwbdshpsstj"]}.=urlencode(${${"GLOBALS"}["xkhabq"]})."=".urlencode(${${"GLOBALS"}["sptbdqe"]})."&";
$jtgyocys="data";
if(substr(${${"GLOBALS"}["erfrgfxmygs"]},-1)=="&")${$jtgyocys}=substr(${${"GLOBALS"}["auexxenf"]},0,-1);
}${${"GLOBALS"}["auexxenf"]}.="\r\n\r\n";
${${"GLOBALS"}["htahytknrfy"]}.="Content-type: application/x-www-form-urlencoded\r\n";
${${"GLOBALS"}["htahytknrfy"]}.="Content-length: ".strlen(${$ycvslrfdjhn})."\r\n";
}${${"GLOBALS"}["htahytknrfy"]}.="\r\n";
if(${${"GLOBALS"}["omumddjkm"]}["method"]=="POST")${${"GLOBALS"}["htahytknrfy"]}.=${$nqdhraem};
${"GLOBALS"}["rlmagcoondi"]="fp";
@fwrite(${${"GLOBALS"}["gplirongicj"]},${$bbrvfdiqc});
${${"GLOBALS"}["yymuyny"]}="";
${$tshdxkrjg}="";
${$edugfoonj}=false;
while(!@feof(${${"GLOBALS"}["rlmagcoondi"]})){$fxzuahsbp="res";
$egvgmmxsuux="h_detected";
$nlsygkhpdyyn="res";
${$nlsygkhpdyyn}.=@fread(${${"GLOBALS"}["gplirongicj"]},1024);
if(!${$egvgmmxsuux}&&strpos(${$fxzuahsbp},"\r\n\r\n")!==FALSE){${"GLOBALS"}["gokexypfnnju"]="res";
$qmvftez="headers";
$sykrwe="res";
$uflxkry="params";
...
if(${$uflxkry}["return"]=="headers"||${$jtjcghsyvtc}["return"]=="array"||(isset(${${"GLOBALS"}["jqqelrlzroq"]}["redirect"])&&${${"GLOBALS"}["omumddjkm"]}["redirect"]==true)){$yjqqdvupnm="v";
$mnbxxtkm="headers";
$dvxenchgyqp="headers";
${${"GLOBALS"}["qzuuekdfv"]}=explode("\r\n",${$mnbxxtkm});
${$dvxenchgyqp}=array();
foreach(${${"GLOBALS"}["qzuuekdfv"]} as${${"GLOBALS"}["idhnrebodii"]}=>${$yjqqdvupnm}){if(strpos(${${"GLOBALS"}["sptbdqe"]},":")){${"GLOBALS"}["ckdqikcutle"]="v";
${"GLOBALS"}["mnmykww"]="v";
${"GLOBALS"}["ugrcqmpr"]="k";
...
}}if(isset(${${"GLOBALS"}["wigpbx"]}["redirect"])&&${${"GLOBALS"}["yergdqrcv"]}["redirect"]==true&&isset(${$qnwjrwbxalvq}["LOCATION"])){${"GLOBALS"}["iweqfuxdlggh"]="params";
${"GLOBALS"}["ljrsgsxuvv"]="params";
${${"GLOBALS"}["omumddjkm"]}["url"]=${${"GLOBALS"}["khvfrulzr"]}["LOCATION"];
if(!isset(${${"GLOBALS"}["omumddjkm"]}["redirect-count"]))${${"GLOBALS"}["iweqfuxdlggh"]}["redirect-count"]=0;
if(${${"GLOBALS"}["ljrsgsxuvv"]}["redirect-count"]<10){${"GLOBALS"}["wrdyls"]="func";
...
}}if(${${"GLOBALS"}["omumddjkm"]}["return"]=="headers")return${${"GLOBALS"}["khvfrulzr"]};
}}@fclose(${$qnklxgjjj});
}else return FALSE;
if(${${"GLOBALS"}["omumddjkm"]}["return"]=="array")${${"GLOBALS"}["yetbvsgk"]}=array("headers"=>${${"GLOBALS"}["khvfrulzr"]},"content"=>${${"GLOBALS"}["yymuyny"]});
return${${"GLOBALS"}["eixfozyikgx"]};
}function error_404(){header("HTTP/1.1 404 Not Found");
...
}function getReferer(){$lfjiopxo="referer";
$frohhtuteye="referer";
${$frohhtuteye}=isset($_SERVER["HTTP_REFERER"])?$_SERVER["HTTP_REFERER"]:"-";
return${$lfjiopxo};
}function getIp(){$zizlckd="ip";
${$zizlckd}=NULL;
if(isset($_SERVER["REMOTE_ADDR"])){${${"GLOBALS"}["hczmyccqa"]}=$_SERVER["REMOTE_ADDR"];
}$ygtqpkoosnxt="ip";
if(strpos(${${"GLOBALS"}["hczmyccqa"]},",")!==FALSE){${"GLOBALS"}["vzzhnqeuoit"]="ip";
